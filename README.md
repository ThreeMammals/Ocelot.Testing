[![Ocelot Logo](/.github/ocelot_icon.png)](https://github.com/ThreeMammals/Ocelot/ "Go to Ocelot repository")
# Ocelot.Testing
...
[![NuGet](https://img.shields.io/nuget/vpre/Ocelot.Testing?logo=nuget)](https://www.nuget.org/packages/Ocelot.Testing/ "Download Ocelot.Testing from NuGet.org")
[![Downloads](https://img.shields.io/nuget/dt/Ocelot.Testing?logo=nuget)](https://www.nuget.org/packages/Ocelot.Testing/ "Total Ocelot.Testing downloads from NuGet.org")
...
## Builds
[![NuGet Stable](https://img.shields.io/nuget/v/Ocelot.Testing?logo=nuget&label=Stable)](https://www.nuget.org/packages/Ocelot.Testing/)
[![NuGet Pre-release](https://img.shields.io/nuget/vpre/Ocelot.Testing?logo=nuget&label=Pre-release)](https://www.nuget.org/packages/Ocelot.Testing/)
